...
- `close_button_att`: A list of HTML attributes for the close button.
...
{% include 'versatile:button' with {
  ...
  content: 'Button text',
  button_att: create_attribute().setAttribute('data-bs-toggle', 'modal').setAttribute('data-bs-target', '#modal-login'),
  button_uc: [
    'mb-2',
    'mb-md-0',
    'btn-outline-white',
