...
- **Integrated Navbar**: Embeds the 'versatile:navbar' component within the navigation.
...
- **Navbar Embedding**: Incorporates the 'versatile:navbar' template with predefined settings for seamless integration.
...
```twig
  {% include 'versatile:page-navigation' %}
```
