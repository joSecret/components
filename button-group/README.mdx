...
```twig
{%
  include 'versatile:button-group' with {
    size: 'lg',
    items: [
      [
        {button_tag: 'button', color: 'primary', content: 'Left'},
        {button_tag: 'button', color: 'primary', content: 'Middle'},
        {button_tag: 'button', color: 'primary', content: 'Right'},
      ],
    ]
  }
%}
