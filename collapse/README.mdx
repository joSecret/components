...
- `button_tag` (optional): (string) Specifies the HTML tag to be used for the collapse trigger. It can be either `button` or `a` (anchor). Defaults to button.
...
```twig
  {%
    include 'versatile:collapse' with {
